...
export const metadata: Metadata = {
  title: "fitted. — Work that actually fits your life",
  description: "Intelligent career guidance that actually knows you — your background, your goals, and where you're headed.",
};
